...
public class Main {
    private static final String DATA_FILE = "data/map.json";
    ...
    public static void main(String[] args) {
        if (!Files.exists(Paths.get(DATA_FILE))) {
            System.out.println("Файл " + DATA_FILE + " не найден");
            return;
        }
    ...
    private static Station takeStation(String message) throws NoSuchElementException {
        for (; ; ) {
...
//            System.out.println("Станция не найдена :(");
            throw new NoSuchElementException("Станция `" + line + "` не найдена :(");
        }
    }
