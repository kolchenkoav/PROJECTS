package epam.dobrov.task1.AmmunitionShop;
/*
...
import epam.dobrov.task1.Ammunition.MotorcycleAmmunition;
...
public class ActionWithAmmunition {
    ...
    //проверка индекс значения с размерностью передаваемого списка
